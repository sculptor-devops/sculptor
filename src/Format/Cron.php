...
namespace Sculptor\Agent\Format;

// FROM https://gist.github.com/m4tthumphrey/8236756
...
class Cron
{
    ...
    final public static function fromCronString($cronSpec = '* * * * * *', $language = 'en')
    {
        ...
        if (isset($elements[5])) {
            $newCron->_cronYears = $newCron->cronInterpret($elements[5], $newCron->RANGE_YEARS_MIN,
                $newCron->RANGE_YEARS_MAX, array(), 'years');
    ...
    final public function asNaturalLanguage()
    {
        ...
        $txtDaysOfMonth[2] = $this->natlangApply('elemDOM: on_X',
            $this->natlangRange($this->_cronDaysOfMonth, array($this, 'natlangElementDayOfMonth')));
        ...
        $txtMonths[2] = $this->natlangApply('elemMonth: during_X',
            $this->natlangRange($this->_cronMonths, array($this, 'natlangElementMonth')));
        ...
        if ($this->_cronYears) {
            ...
            $txtYears[2] = ' ' . $this->natlangApply('elemYear: in_X',
                    $this->natlangRange($this->_cronYears, array($this, 'natlangElementYear')));
